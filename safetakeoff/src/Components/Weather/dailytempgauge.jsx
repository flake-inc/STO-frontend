...
const getDefaultConditions = (conditions) => ({
  sunny:
    "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/sunny.png",
  cloudy:
    "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/cloudy.png",
  rainy:
    "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/rain.png",
  stormy:
    "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/tstorms.png",
  snow: "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/snow.png",
  default:
    "https://raw.githubusercontent.com/KevinMellott91/react-weather-display/master/images/mostlysunny.png",
  ...conditions,
});
...
class ReactWeatherDisplay extends Component {
  ...
  getForecastImage = () => {
    const condition =
      this.conditions[this.getCurrentCondition()] || this.conditions.default;
