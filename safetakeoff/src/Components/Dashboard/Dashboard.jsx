  ...
  return (
    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            <Grid item xs={12} sx={{ mb: -2.25, mt: 4}}>
                <Typography variant="h5">Today Statistics:</Typography>
            </Grid>
            ...
            <Grid item xs={12} md={7} lg={8}>
                <Grid container alignItems="center" justifyContent="space-between">
                    <Grid item>
                        <Typography variant="h5">Sample Graph</Typography>
                    </Grid>
                    <Grid item>
            ...
            <Grid item xs={12} md={7} lg={8}>
                ...
                <MainCard sx={{ mt: 2 }} content={false}>
                    ...
                    {Object.keys(articles).map(function(key, index) {
                                return <Typography key={key} value={articles[key]}>
                                {key} - {articles[key]}
                            </Typography>
                            })}
                </MainCard>
            ...
            <Grid item xs={12} md={7} lg={8}>
                <Grid container alignItems="center" justifyContent="space-between">
                    <Grid item>
                        <Typography variant="h5">Sample Row</Typography>
                    </Grid>
                    <Grid item>
                        <TextField
